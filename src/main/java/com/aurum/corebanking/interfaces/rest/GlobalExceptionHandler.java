package com.aurum.corebanking.interfaces.rest;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUnprocessable(RuntimeException ex) {
        return problem(HttpStatus.valueOf(422), ex.getMessage());
    }
    ...
    private ResponseEntity<Map<String, Object>> problem(@NonNull HttpStatus status, String detail) {
