...
import com.aurum.corebanking.infrastructure.persistence.entity.AccountEntity.AccountEntityBuilder;
...
public class TransferSteps {
    ...
    public void accountHasBalance(String accountRef, double balance) {
        @SuppressWarnings("null")
        AccountEntity account = accountRepository.save(extracted(accountRef)
    ...
    private AccountEntityBuilder extracted(String accountRef) {
